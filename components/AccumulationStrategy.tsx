       ...
       <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center">
                ...
                <div className="w-full sm:w-1/2 flex items-center justify-between bg-slate-50 dark:bg-slate-800 p-4 rounded-lg">
                    <div><span className="block text-xs text-slate-500">Target Age</span><span className="text-xl font-bold">{profile.age + investmentLength}</span></div>
       ...
       <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 rounded-2xl text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative">
            ...
            <div className="flex items-center gap-5 relative z-10">
                ...
                <div>
                    ...
                    <p className="text-blue-100 mt-1 max-w-sm">Apply your projected <strong>Age {profile.age + investmentLength}</strong> balances to the withdrawal calculator.</p>
                </div>
            </div>
            <button 
